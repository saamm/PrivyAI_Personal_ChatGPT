# this code defines a function to generate a concise title for a user query using an LLM
# it uses a prompt template to guide the LLM in creating the title
