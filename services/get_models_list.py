# this code defines a function to retrieve a list of Ollama models from configuration settings
# it reads a comma-separated string from environment variables and converts it into a list
#
